...
var PickerStyleTag = /* @__PURE__ */ (0, import_react.memo)(function PickerStyleTag$1() {
...
function indexEmoji(emoji) {
	emojiNames(emoji).flat().join("").toLowerCase().replace(/[^a-zA-Z\d]/g, "").split("").forEach(function(_char) {
...
function useIsUnicodeHidden() {
	...
	return function(emojiUnified$1) {
		return unicodeToHide.has(emojiUnified$1);
	};
}
...
function mergeCategoriesConfig(userCategoriesConfig, modifiers) {
	...
	var extra = {};
	if (modifiers.suggestionMode === SuggestionMode.RECENT) extra[Categories.SUGGESTED] = SuggestedRecent;
...
function emojiByUnified(unified) {
	...
	return allEmojisByUnified[unifiedWithoutSkinTone(unified)];
}
...
function setCustomEmojis(customEmojis) {
	...
	customEmojis.forEach(function(emoji) {
		...
		if (allEmojisByUnified[emojiData[EmojiProperties.unified]]) return;
...
setTimeout(function() {
	allEmojis.reduce(function(allEmojis$1, Emoji) {
		allEmojis$1[emojiUnified(Emoji)] = Emoji;
		if (emojiHasVariations(Emoji)) emojiVariations(Emoji).forEach(function(variation) {
...
function mergeConfig(userConfig) {
	...
	var categories = mergeCategoriesConfig(userConfig.categories, { suggestionMode: config.suggestedEmojisMode });
...
function filterEmojiObjectByKeyword(emojis$1, keyword) {
	var filtered = {};
	for (var unified in emojis$1) {
		var emoji = emojis$1[unified];
...
function useOnFocus() {
	...
	(0, import_react.useEffect)(function() {
		...
		function onFocus(event) {
			...
			if (!emoji) return;
			if (emojiHasVariations(emoji)) preloadEmoji(getEmojiUrl, emoji, emojiStyle);
		}
	}, [
		BodyRef,
		emojiStyle,
...
function originalUnifiedFromEmojiElement(emoji) {
	...
	if (unified) return unifiedWithoutSkinTone(unified);
	return null;
}
...
function useMouseDownHandlers(ContainerRef, mouseEventSource) {
	...
	var onMouseDown = (0, import_react.useCallback)(function onMouseDown$1(event) {
		...
		if (!emoji || !emojiHasVariations(emoji)) return;
...
function ClickableEmojiButton(_ref) {
	...
	return (0, import_react.createElement)(Button, {
		...
		"aria-label": getAriaLabel(emojiNames$1),
		"data-full-name": emojiNames$1,
		style
	}, children);
}
function getAriaLabel(emojiNames$1) {
	var _emojiNames$;
	return emojiNames$1[0].match("flag-") ? (_emojiNames$ = emojiNames$1[1]) != null ? _emojiNames$ : emojiNames$1[0] : emojiNames$1[0];
}
...
function EmojiImg(_ref) {
	var emojiName$1 = _ref.emojiName, style = _ref.style, _ref$lazyLoad = _ref.lazyLoad, lazyLoad = _ref$lazyLoad === void 0 ? false : _ref$lazyLoad, imgUrl = _ref.imgUrl, onError = _ref.onError, className = _ref.className;
...
function useEmojiVirtualization(_ref) {
	...
	var emojis$1 = emojisToPush.reduce(function(accumulator, emoji, index) {
		var unified = emojiUnified(emoji, activeSkinTone);
...
function RenderCategory(_ref2) {
	...
	}), virtualizedCounter = _useEmojiVirtualizati.virtualizedCounter, emojis$1 = _useEmojiVirtualizati.emojis, dimensions = _useEmojiVirtualizati.dimensions;
	return (0, import_react.createElement)(EmojiCategory, {
		categoryConfig,
		height: dimensions == null ? void 0 : dimensions.categoryHeight,
		hidden: !emojis$1.length && virtualizedCounter === 0
	}, emojis$1);
}
...
function PreviewBody() {
	...
	function PreviewContent() {
		...
		return (0, import_react.createElement)(import_react.Fragment, null, (0, import_react.createElement)("div", null, show ? (0, import_react.createElement)(ViewOnlyEmoji, {
			...
			getEmojiUrl,
			className: cx(styles$e.emoji)
		}) : null), (0, import_react.createElement)("div", { className: cx(styles$e.label) }, show ? emojiName(emoji) : defaultText));
	}
}
...
var styles$f = /* @__PURE__ */ stylesheet.create(/* @__PURE__ */ _extends({ catBtn: {
	".": "epr-cat-btn",
...
//#endregion
export { Categories, ExportedEmoji as Emoji, EmojiStyle, SkinTonePickerLocation, SkinTones, SuggestionMode, Theme, emoji_picker_react_esm_default as default, emojiByUnified };
